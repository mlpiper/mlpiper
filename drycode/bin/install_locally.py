...
def main():
    print("Installing drycode locally")

    drycode_dir = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
    print("drycode dir: {}".format(drycode_dir))

    dist_dir = os.path.join(drycode_dir, "dist")
