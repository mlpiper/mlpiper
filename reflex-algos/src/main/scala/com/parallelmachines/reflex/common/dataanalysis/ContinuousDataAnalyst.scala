package com.parallelmachines.reflex.common.dataanalysis
...
object ContinuousDataAnalyst {
  ...
  def analyze(rddOfNamedVector: RDD[ReflexNamedVector]): mutable.Map[String, ContinuousDataAnalysisResult] = {
