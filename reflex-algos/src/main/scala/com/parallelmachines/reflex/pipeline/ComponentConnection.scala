...
case class ComponentConnection[T](val tag: TypeTag[T],
                                  val defaultComponentClass: Option[Class[_]] = None,
                                  var sideComponentClass: Option[Class[_]] = None,
                                  val eventTypeInfo: Option[EventTypeInfo] = None,
                                  val label: String = "",
                                  val description: String = "",
                                  val group: ConnectionGroups = ConnectionGroups.OTHER,
