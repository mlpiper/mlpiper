...
import org.mlpiper.datastructures.{NamedMatrix, NamedVector}
...
class ContinuousHistogramForSpark(healthName: String) extends HealthComponentSpark {
  ...
  def createHealth(): Option[mutable.Map[String, ContinuousHistogram]] = {
    ...
    var rddOfNamedVector: RDD[NamedVector] = null
    var rddOfNamedMatrix: RDD[NamedMatrix] = null
    ...
    val genericHealthForContinuousFeatures = new ContinuousHealth(healthName)
...
object ContinuousHistogramForSpark {
  ...
  /**
    ...
    */
  def getMinMaxBinRange(rddOfNamedVectorNumerics: RDD[NamedVector],
