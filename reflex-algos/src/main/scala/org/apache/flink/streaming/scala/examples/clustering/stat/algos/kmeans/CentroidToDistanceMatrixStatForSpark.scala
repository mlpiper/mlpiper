...
import org.apache.flink.streaming.scala.examples.clustering.stat.utils.DistanceMatrixStatGenerator
...
class CentroidToDistanceMatrixStatForSpark(sparkContext: org.apache.spark.SparkContext) extends Serializable {
  ...
  def generateDistanceMatrixStat(model: org.apache.spark.mllib.clustering.KMeansModel): Unit = {
