 ...
 */
package org.apache.flink.streaming.scala.examples.common.parameters.stat
...
case object CorrelationType extends StringParameter {
  override val key: String = "method"
  override val label: String = "Correlation Type"
  override val required: Boolean = true
  override val description: String = "Correlation Type (i.e. pearson)"
  override val errorMessage: String = "Specify correlation method"
