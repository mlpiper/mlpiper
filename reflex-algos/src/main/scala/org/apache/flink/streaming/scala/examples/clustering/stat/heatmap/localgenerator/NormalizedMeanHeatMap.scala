...
/**
  * Compute HeatMap by using "local-by-norm-mean" methodology on mini-batch of ReflexNamedVectors
  *
...
class NormalizedMeanHeatMap
  extends RichFlatMapFunction[Iterable[ReflexNamedVector], HeatMapValues] {
  ...
  /**
    ...
    */
  override def flatMap(value: Iterable[ReflexNamedVector],
