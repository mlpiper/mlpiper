...
object NamedMatrixToFeaturedHistogram {
  ...
  /**
    * Method/API is responsible for creating Featured Histogram from ReflexNamedMatrix.
    */
  def apply(namedMatrixRep: ReflexNamedMatrix): mutable.Map[String, Histogram] = {
