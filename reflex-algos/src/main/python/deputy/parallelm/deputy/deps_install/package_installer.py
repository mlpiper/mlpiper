...
class PackageInstaller(object):
    def __init__(self, packages, script_prefix, script_extension):
        ...
        self._extension = script_extension if script_extension.startswith(".") else ".{}".format(script_extension)
    ...
    def install(self):
        if self._packages:
            ...
            try:
                ...
                self._logger.info("Installing components dependencies ... {}".format(self._packages))
