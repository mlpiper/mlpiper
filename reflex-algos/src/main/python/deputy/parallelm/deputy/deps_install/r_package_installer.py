...
class RPackageInstaller(PackageInstaller):
    ...
    def __init__(self, packages):
        ...
        super(RPackageInstaller, self).__init__(packages, script_prefix="requirements-", script_extension=".R")

    def _script_content(self, packages):
        return RPackageInstaller.INSTALL_SCRIPT.substitute(packages=", ".join(["'%s'" % p for p in packages]))
